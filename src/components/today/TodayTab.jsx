...
export default function TodayTab() {
  const { sections, checks, streaks, loading, saveStatus, toggle, done, total, pct } = useHabits();
  ...
  return (
    <div className="tab-content flex-1 flex flex-col pb-24">
      ...
      <div className="px-4 pt-14 pb-6 bg-gradient-to-b from-bg-elevated/80 to-transparent">
        ...
        <SaveDot status={saveStatus} className="mt-3" />
      </div>

      {/* Offline banner */}
      {!navigator.onLine && (
        <div className="mx-4 mb-3 flex items-center gap-2 bg-warn/10 border border-warn/30
                        rounded-xl px-3 py-2.5 text-xs text-warn">
